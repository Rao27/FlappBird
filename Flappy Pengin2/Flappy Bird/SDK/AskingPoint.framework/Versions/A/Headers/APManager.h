...
typedef BOOL (^APManagerTagRequestComplete)(NSString *tag, APCommand *command);
...
+(void)requestCommandsWithTag:(NSString *)tag completionHandler:(APManagerTagRequestComplete)completionHandler;
