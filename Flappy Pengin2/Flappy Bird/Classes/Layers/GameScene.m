...
//    m_sObstacle[0].position = ccp(m_sObstacle[0].position.x, (tmp + (defaultHeight - m_iObstacleCnt * 2)) * G_SCALEY / g_fScaleR);
//    m_sObstacle[1].position = ccp(m_sObstacle[1].position.x, (tmp - (defaultHeight - m_iObstacleCnt * 2)) * G_SCALEY / g_fScaleR);
...
//    m_sObstacle[2].position = ccp(m_sObstacle[2].position.x, (tmp + (defaultHeight - m_iObstacleCnt * 2)) * G_SCALEY / g_fScaleR);
//    m_sObstacle[3].position = ccp(m_sObstacle[3].position.x, (tmp - (defaultHeight - m_iObstacleCnt * 2)) * G_SCALEY / g_fScaleR);
...
//    tmp = arc4random() % 256 + 180;
//    m_sObstacle[4].position = ccp(m_sObstacle[4].position.x, (tmp + (defaultHeight - m_iObstacleCnt * 2)) * G_SCALEY / g_fScaleR);
//    m_sObstacle[5].position = ccp(m_sObstacle[5].position.x, (tmp - (defaultHeight - m_iObstacleCnt * 2)) * G_SCALEY / g_fScaleR);
...
- (void) createBackground{
    ...
    m_sBirdSprite = newSprite(@"bat0", getX(90), getY(230), self, 1, RATIO_X);
...
//    m_sGroundSprite[0] = newSprite(@"tunnel_bottom_01", getX(10), getY(456), self, 0, RATIO_XY);
//    m_sGroundSprite[1] = newSprite(@"tunnel_bottom_01", getX(150), getY(456), self, 0, RATIO_XY);
    ...
    m_sGroundSprite[16] = newSprite(@"tunnel_bottom_08", m_sGroundSprite[15].position.x+45, getY(385), self, 0, RATIO_XY);
...
#ifdef FREE_VERSION
    int nRandomeFree = arc4random() % 100;
...
//            if(m_iObstacleCnt < 30) m_iObstacleCnt++;
            m_iObstacleCnt++;
            m_sObstacle[i].position = ccp(m_sObstacle[i].position.x + 600.0 * G_SCALEX / g_fScaleR, (tmp + (defaultHeight - m_iObstacleCnt)) * G_SCALEY / g_fScaleR);
            m_sObstacle[i + 1].position = ccp(m_sObstacle[i].position.x, (tmp - (defaultHeight - m_iObstacleCnt)) * G_SCALEY / g_fScaleR);
...
//    }
        ...
        if(CGRectIntersectsRect([m_sGroundSprite[0] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[1] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[2] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[3] boundingBox], m_sBirdSprite.boundingBox) ||CGRectIntersectsRect([m_sGroundSprite[4] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[5] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[6] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[7] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[8] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[9] boundingBox], m_sBirdSprite.boundingBox) )
        {
            [self gameEnd];
        }
        
        if(CGRectIntersectsRect([m_sGroundSprite[10] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[11] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[12] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[13] boundingBox], m_sBirdSprite.boundingBox) ||CGRectIntersectsRect([m_sGroundSprite[14] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[15] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[16] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sGroundSprite[17] boundingBox], m_sBirdSprite.boundingBox))
        {
            [self gameEnd];
        }
    
    if(CGRectIntersectsRect([m_sTopSprite[0] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[1] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[2] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[3] boundingBox], m_sBirdSprite.boundingBox) ||CGRectIntersectsRect([m_sTopSprite[4] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[5] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[6] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[7] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[8] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[9] boundingBox], m_sBirdSprite.boundingBox) )
    {
        [self gameEnd];
    }
    
    if(CGRectIntersectsRect([m_sTopSprite[10] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[11] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[12] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[13] boundingBox], m_sBirdSprite.boundingBox) ||CGRectIntersectsRect([m_sTopSprite[14] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[15] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[16] boundingBox], m_sBirdSprite.boundingBox) || CGRectIntersectsRect([m_sTopSprite[17] boundingBox], m_sBirdSprite.boundingBox))
    {
        [self gameEnd];
    }
